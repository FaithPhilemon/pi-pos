...
(function ($) {
    $.fn.imageUploader = function (options) {
        ...
        let defaults = { preloaded: [], imagesInputName: (inputName == ''?"images":inputName), preloadedInputName: "preloaded", label: (inputLabel== ''?"Drag & Drop files here or click to browse":inputLabel) };
        let plugin = this;
        plugin.settings = {};
        ...
        let createContainer = function () {
            let $container = $("<div>", { class: "image-uploader" }),
                ...
                $i = $("<i>", { class: "ik ik-upload-cloud", text: "" }).appendTo($textContainer),
        ...
        let createImg = function (src, id) {
            let $container = $("<div>", { class: "uploaded-image" }),
                ...
                $i = $("<i>", { class: "ik ik-x", text: "" }).appendTo($button);
            if (plugin.settings.preloaded.length) {
