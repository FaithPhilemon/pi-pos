                        ...
                        <table id="data_table" class="table">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    ...
                                    <!-- Edit Modal -->
                                    <div class="modal fade" id="editSubModal{{ $category->id }}" tabindex="-1" role="dialog" aria-labelledby="editSubModal" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editSubModal">Edit Category</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample mb-20" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
